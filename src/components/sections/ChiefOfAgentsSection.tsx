...
export function ChiefOfAgentsSection() {
  ...
  return (
    <section id="chief-of-agents" className="py-28 md:py-36 relative bg-[#070913] text-white border-t border-white/15 atmosphere-violet">
      <div className="max-w-7xl mx-auto px-6 sm:px-16 relative z-10">
        ...
        <div className="grid grid-cols-1 lg:grid-cols-12 gap-8 mb-16 items-stretch">
          {/* Problem Card (7 cols) */}
          <div className="lg:col-span-7 p-8 sm:p-10 bg-black/70 border border-violet-500/20 hover:border-violet-400/40 rounded-sm shadow-xl space-y-4 transition-all flex flex-col justify-between">
            ...
            <div className="pt-4 border-t border-white/10 flex items-center justify-between font-mono text-[11px] text-violet-300">
          ...
          <div className="lg:col-span-5 p-6 bg-violet-950/20 border border-violet-500/30 rounded-sm shadow-2xl relative overflow-hidden flex flex-col justify-between">
            ...
            <div className="relative py-6 flex items-center justify-center min-h-[160px] z-10">
              <div className="absolute inset-0 flex items-center justify-center pointer-events-none">
                <div className="w-48 h-48 rounded-full border border-dashed border-violet-500/30 animate-spin" style={{ animationDuration: "25s" }} />
              </div>

              <div className="relative z-20 w-20 h-20 rounded-full bg-gradient-to-tr from-violet-600 via-indigo-700 to-cyan-500 p-0.5 shadow-[0_0_30px_rgba(139,92,246,0.5)] flex items-center justify-center text-center font-mono">
                <div className="w-full h-full rounded-full bg-slate-950 flex flex-col items-center justify-center p-1">
                  <span className="text-[7px] text-cyan-400 font-bold">CHIEF</span>
                  <Bot className="w-4 h-4 text-white animate-bounce" />
                  <span className="text-[6px] text-slate-400">MASTER</span>
                </div>
              </div>

              <div className="absolute top-1 left-4 px-2 py-1 rounded-xs bg-black/90 border border-blue-400/50 text-[8px] font-mono text-blue-300 shadow-md">
                🧠 PLANNER
              </div>
              <div className="absolute top-1 right-4 px-2 py-1 rounded-xs bg-black/90 border border-emerald-400/50 text-[8px] font-mono text-emerald-300 shadow-md">
                ⚡ CODER
              </div>
              <div className="absolute bottom-1 left-4 px-2 py-1 rounded-xs bg-black/90 border border-amber-400/50 text-[8px] font-mono text-amber-300 shadow-md">
                🛡️ REVIEWER
              </div>
              <div className="absolute bottom-1 right-4 px-2 py-1 rounded-xs bg-black/90 border border-rose-400/50 text-[8px] font-mono text-rose-300 shadow-md">
                🚀 SHIPPER
              </div>
            </div>

            <div className="text-[9px] font-mono text-slate-400 flex items-center justify-between border-t border-white/10 pt-2 relative z-10">
        ...
        {/* ---------------------------------------------------- */}
        <div className="mb-20 p-8 sm:p-12 bg-black/85 border border-violet-500/30 rounded-sm shadow-2xl space-y-8 relative overflow-hidden">
          ...
          <div className="flex flex-col sm:flex-row sm:items-center justify-between border-b border-white/15 pb-4 gap-2 font-mono">
            ...
            <div className="flex items-center gap-2">
              ...
              <span className="text-[11px] text-cyan-300 font-mono font-bold tracking-wider">
          ...
          <div className="grid grid-cols-2 sm:grid-cols-4 lg:grid-cols-8 gap-3 font-mono">
            {workflowSteps.map((step, idx) => {
              ...
              return (
                <div
                  key={step.num}
                  className="p-4 bg-violet-950/20 hover:bg-violet-900/30 border border-violet-500/25 hover:border-cyan-400 rounded-sm flex flex-col justify-between min-h-[140px] h-full relative group transition-all duration-300 hover:shadow-[0_0_20px_rgba(139,92,246,0.3)] hover:-translate-y-1"
                >
                  <div className="flex items-center justify-between">
                    <span className="text-violet-400 font-serif font-bold text-sm group-hover:text-cyan-300 transition-colors">
                      {step.num}
                    </span>
                    <Icon className="w-3.5 h-3.5 text-violet-300 group-hover:scale-125 group-hover:text-cyan-300 transition-all" />
                  </div>
                  <div>
                    <div className="text-xs font-bold text-white font-serif tracking-wider group-hover:text-cyan-300 transition-colors">
                      {step.name}
                    </div>
        ...
        {/* ---------------------------------------------------- */}
        <div className="p-8 sm:p-14 bg-black/90 border border-violet-500/30 rounded-sm shadow-2xl space-y-6">
          <div className="flex items-center gap-2 text-xs font-mono text-violet-400 font-bold uppercase tracking-widest">
          ...
          <blockquote className="space-y-2">
            ...
            <h3 className="text-2xl sm:text-4xl lg:text-5xl font-serif font-bold text-violet-300 tracking-tight leading-tight">
              It doesn&apos;t make software engineering disappear.
            </h3>
          </blockquote>

          <div className="grid grid-cols-1 md:grid-cols-2 gap-8 pt-4 border-t border-white/15 text-xs sm:text-sm text-slate-300 font-sans leading-relaxed">
            <p>
              {t(
          ...
          <div className="pt-4 border-t border-white/10 flex flex-wrap items-center justify-between gap-4 font-mono text-xs">
            ...
            <Link
              href="#projects"
              className="inline-flex items-center gap-1.5 text-violet-300 hover:text-white uppercase font-bold tracking-widest text-[11px]"
            >
