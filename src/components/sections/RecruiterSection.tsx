...
export function RecruiterSection() {
  ...
  return (
    <section id="for-recruiters" className="py-20 sm:py-28 lg:py-36 relative bg-[#06080e] text-white border-t border-white/15 atmosphere-blue">
      <div className="max-w-7xl mx-auto px-4 sm:px-8 lg:px-16 relative z-10">
        ...
        <div className="p-5 sm:p-10 lg:p-14 bg-black/80 border border-blue-500/30 rounded-sm shadow-2xl space-y-6 sm:space-y-10">
          
          {/* Top Quick Bar */}
          <div className="grid grid-cols-1 xs:grid-cols-2 lg:grid-cols-4 gap-6 sm:gap-8 pb-6 sm:pb-8 border-b border-white/15 font-mono text-xs">
            
            {/* Identity & Focus */}
            <div className="space-y-1.5 sm:space-y-2">
              <span className="text-[9px] sm:text-[10px] text-blue-400 font-bold uppercase tracking-widest block">
              ...
              <div className="text-[11px] sm:text-xs text-blue-300 font-semibold">
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-4 sm:gap-6 lg:gap-8 text-xs font-sans">
            
            {/* Core Strengths */}
            <div className="space-y-3 p-5 sm:p-6 bg-blue-950/20 border border-blue-500/20 rounded-sm">
              ...
              <ul className="space-y-1.5 sm:space-y-2 text-slate-200">
            ...
            {/* What I Bring */}
            <div className="space-y-3 p-5 sm:p-6 bg-violet-950/20 border border-violet-500/20 rounded-sm">
            ...
            <div className="space-y-3 p-5 sm:p-6 bg-cyan-950/20 border border-cyan-500/20 rounded-sm">
          ...
          {/* Action Row */}
          <div className="pt-4 sm:pt-6 border-t border-white/15 flex flex-col sm:flex-row items-stretch sm:items-center justify-between gap-3 sm:gap-4 font-mono text-xs">
            <Link
              href="/cv"
              className="inline-flex items-center justify-center gap-2 px-6 py-3.5 bg-white text-black font-bold uppercase tracking-widest text-[11px] rounded-sm hover:bg-slate-200 transition-colors shadow-lg touch-target text-center"
            >
            ...
            <Link
              href="#contact"
              className="inline-flex items-center justify-center gap-2 text-blue-300 hover:text-white font-bold uppercase tracking-widest text-[11px] touch-target text-center"
            >
